...
cyg_count32  cyg_thread_get_mutex_count( cyg_handle_t thread );
cyg_mutex_t *cyg_thread_get_mutex_list( cyg_handle_t thread );
cyg_mutex_t *cyg_thread_get_mutex_waiting( cyg_handle_t thread );
void cyg_thread_mark( cyg_handle_t thread );
void cyg_thread_unmark( cyg_handle_t thread );
bool cyg_thread_marked( cyg_handle_t thread );
#endif
