...
Cyg_Thread::~Cyg_Thread()
{
    ...
    if ( this->get_mutex_count() > 0 )
    {
        diag_printf( "### Deleting thread %08x holding mutex %d %08x\n",
                     (int) this,
                           this->get_mutex_count(),
                     (int) this->get_mutex_list() );
    }
...
//    if ( current->get_mutex_count() > 0 )
//    {
//        diag_printf( "### Sleeping thread %08x holding mutex %d %08x\n",
//                     (int) current,
//                           this->get_mutex_count(),
//                     (int) current->get_mutex_list() );
//    }
...
Cyg_Thread::suspend()
{
    ...
    if ( this->get_mutex_count() > 0 )
    {
        diag_printf( "### Suspending thread %08x holding mutex %d %08x\n",
                     (int) this,
                           this->get_mutex_count(),
                     (int) this->get_mutex_list() );
    }
...
Cyg_Thread::kill()
{
    ...
    if ( this->get_mutex_count() > 0 )
    {
        diag_printf( "### Killing thread %08x holding mutex %d %08x\n",
                     (int) this,
                           this->get_mutex_count(),
                     (int) this->get_mutex_list() );
    }
    ...
    case TIMEOUT:
        // The thread was waiting on a sync object with a timeout.
        // drop through...
        diag_printf( "### Killing thread %08x waiting on sync\n",
                     (int) this );
