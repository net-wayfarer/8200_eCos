...
cyg_bool cyg_hal_dsr_periph_active;
...
static void hal_dsr_periph( cyg_vector_t    vector,
                            ...
                            cyg_addrword_t  data )
{
    cyg_hal_dsr_periph_active = true;
    ...
    cyg_hal_dsr_periph_active = false;
...
{
    if ( subIsrNum == uart_irq_bits[0] )
    {
        // Crash because someone is disabling the UART!
        *(int*)0 = 0;
    }
    if ( subIsrNum < 32 )
    {
