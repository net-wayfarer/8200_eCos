...
static int bcm7xxx_28nm_config_init(struct phy_device *phydev)
{
	...
	/* special link satus interrupt workaround*/
	/* turn on GPHY APD via MDIO bus */
	phy_write(phydev, 0x1C, 0xA821);
...
static int bcm7xxx_28nm_probe(struct phy_device *phydev)
{
	...
	if (IS_ERR(priv->clk)) {
		dev_err(&phydev->dev, "did not get GPHY clock\n");
		priv->clk = NULL;
	}
...
static struct phy_driver bcm7xxx_driver[] = {
	...
	BCM7XXX_28NM_GPHY(PHY_ID_BCM3390, "Broadcom BCM3390"),
	BCM7XXX_28NM_GPHY(PHY_ID_BCM53134, "Broadcom BCM53134"),
	BCM7XXX_28NM_GPHY(PHY_ID_BCM53124, "Broadcom BCM53124"),
{
...
static struct mdio_device_id __maybe_unused bcm7xxx_tbl[] = {
	...
	{ PHY_ID_BCM3390, 0xfffffff0, },
	{ PHY_ID_BCM53134, 0xfffffff0, },
	{ PHY_BCM_OUI_4, 0xffffff00 },
