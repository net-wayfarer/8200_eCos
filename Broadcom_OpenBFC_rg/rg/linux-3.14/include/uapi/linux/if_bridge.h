...
#define BRCTL_ENABLE_IGMP_LAN2LAN_MC 30
#define BRCTL_ENABLE_MLD_LAN2LAN_MC  31

#define BRCTL_GET_IGMP_LAN_TO_LAN_MCAST_ENABLED 32
#define BRCTL_GET_MLD_LAN_TO_LAN_MCAST_ENABLED  33
#endif
