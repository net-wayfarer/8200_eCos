...
struct br_dbevent_notifier {
	int (*fcn)(struct net_bridge *br, int dbtype, int event,
		   void *dbitem, void *dbitemext);
};
extern struct br_dbevent_notifier __rcu *dbevent_cb;
int br_register_dbevent_notifier(struct br_dbevent_notifier *cb);
void br_unregister_dbevent_notifier(struct br_dbevent_notifier *cb);
#endif
...
#if IS_ENABLED(CONFIG_IPV6_MAP)
int br_dev_queue_push_xmit2(struct sk_buff *skb, void *arg);
#endif
